    ...
    <div className="container mx-auto">
      ...
      <Form
        ...
        onFinish={(values) => {
          ...
          if (values.networkData.date)
            dataForApi.networkData.date =
              values.networkData.date && new Date(values.networkData.date).toISOString();
      ...
      >
        ...
        <div className=" bg-white shadow rounded mb-4 border-b p-8">
          ...
          <div className="w-full h-20 border my-2" />
        </div>
