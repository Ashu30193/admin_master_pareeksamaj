...
const Occupation = ({ dispatch, siteConfig, getLoading }) => {
  ...
  return (
      ...
      onFinish={(event) => {
        Promise.all([
          dispatch({
            ...
            payload: {
              pathParams: { key: 'occupation' },
              body: {
                occupation: [
                  ...siteConfig.siteConfig.occupation,
                  {
                    name:
    ...
    >
      <CardSection
        ...
        leftContent={
          <div className="pr-8 ">
            <div className="text-blue-900 font-semibold text-xl">Occupation</div>
            <div className="text-gray-600">
              <p className="mt-4">Enter Occupation Tags</p>
            </div>
          </div>
        }
        rightContent={
          <div className="p-4 bg-white shadow rounded">
            <div className="tags-input">
              <div className="flex flex-wrap mb-4">
                {siteConfig?.siteConfig?.occupation.map((tag, index) => (
                  <div key={index} className="font-semibold bg-gray-200 rounded-full px-4 py-1 m-1">
                    {tag.name}
                    <CloseOutlined
                      onClick={() => {
                        const newArray = siteConfig.siteConfig.occupation;
