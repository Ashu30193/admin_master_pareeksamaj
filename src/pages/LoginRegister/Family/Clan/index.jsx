...
const Clan = ({ dispatch, siteConfig, getLoading }) => {
  ...
  return (
    ...
    >
      <CardSection
        ...
        leftContent={
          <div className="pr-8 ">
            <div className="text-blue-900 font-semibold text-xl">Clan</div>
            <div className="text-gray-600">
              <p className="mt-4">Enter Clan Tags</p>
            </div>
          </div>
        }
        rightContent={
